        ...
        >
            <div className="categorymenu-manager">
                <div className="categorymenu-manager__filter">
                    <div className="categorymenu-manager__filter-name">
                        <InputField
                    ...
                    <div className="categorymenu-manager__filter-date">
                        <DatePicker
                    ...
                    <div className="categorymenu-manager__filter-create-new">
                        <Button2
                ...
                <Popup
                    ...
                    body={
                        <div className="categorymenu-manager__popup">
                            <Input
                                label={"Mã danh mục"}
