    ...
    baseApi.post(
      (res) => {
        ...
        commonFunction.messages(
          ...
          "Thêm phiếu oder thành công!"
        );
      },
      () => {
        commonFunction.messages(
          TYPE_MESSAGE.ERROR,
          "Thêm phiếu oder thất bại!"
        );
      },
      null,
    ...
    <div className="order-page-container">
      <div className="order-page-container__food-list">
        <div className="order-page-container__food-list__top">
          <div
            className="order-page-container__food-list__top-back"
            onClick={() => {
              window.open("/admin/tables", "_self");
            }}
          >
        ...
        <div className="order-page-container__food-list__list">
          {listMenu && listMenu?.length > 0
            ? listMenu?.map((item) => {
                return (
                  <div
                    className="order-page-container__food-list__list-item"
                    onClick={(e) => {
                      e.stopPropagation();
        ...
        <div className="order-page-container__food-list__choose">
          {listType?.map((item, key) => {
            return (
              <div
                className={`order-page-container__food-list__choose__children ${
      ...
      <div className="order-page-container__selected-dish">
        ...
        <div
          className="order-page-container__selected-dish-content"
          ref={renderChoose}
        >
            ...
            orderSelected?.map((item) => {
              return (
                <div className="order-page-container__selected-dish-content-choose">
                  <div
                    className="order-page-container__selected-dish-content-choose-line1"
                    onMouseEnter={() =>
                      setDisplayLine2ChooseOrder({ show: true, index: item.id })
                    }
                    onMouseLeave={() =>
                      setDisplayLine2ChooseOrder({ show: false, index: "" })
                    }
                  ...
                  >
                    ...
                    <div className="food-money">
                      {commonFunction.numberWithCommas(parseInt(item.donGia))}
                      (đ)
                    </div>
                  </div>
                  {displayLine2ChooseOrder.show &&
                    displayLine2ChooseOrder.index == item.id && (
                      <div
                        className="order-page-container__selected-dish-content-choose-line2"
                        onMouseEnter={() =>
                      ...
                      >
                        <div className="food-count">
                          <div className="food-count-button">
                            <Tooltip title={"Giảm số lượng"} placement="bottom">
                              <Button2
                                name={"-"}
                          ...
                          <div className="food-count-button">
                            <Tooltip title={"Tăng số lượng"} placement="bottom">
                              <Button2
                                name={"+"}
